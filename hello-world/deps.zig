...
pub const dirs = struct {
    pub const _root = "";
    pub const _e6noiqie8yse = cache ++ "/../..";
    pub const _yw0gnhjyj2lm = cache ++ "/v/git/github.com/Sobeston/table-helper/commit-0b86eef2640a3d97d538d9fc135ae7628e99c7b5";
};

pub const package_data = struct {
    pub const _e6noiqie8yse = Package{
        .directory = dirs._e6noiqie8yse,
    };
    pub const _yw0gnhjyj2lm = Package{
        .directory = dirs._yw0gnhjyj2lm,
        .pkg = Pkg{ .name = "table-helper", .source = .{ .path = dirs._yw0gnhjyj2lm ++ "/table-helper.zig" }, .dependencies = null },
    };
...
pub const packages = &[_]Package{
    package_data._yw0gnhjyj2lm,
};

pub const pkgs = struct {
    pub const table_helper = package_data._yw0gnhjyj2lm;
};
